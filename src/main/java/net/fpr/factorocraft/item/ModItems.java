...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(Factorocraft.MOD_ID);

    public static final DeferredItem<Item> AUTOMATION_SCIENCE_PACK = ITEMS.register("science_pack_automation",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> LOGISTIC_SCIENCE_PACK = ITEMS.register("science_pack_logistic",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> CHEMICAL_SCIENCE_PACK = ITEMS.register("science_pack_chemical",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> MILITARY_SCIENCE_PACK = ITEMS.register("science_pack_military",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> PRODUCTION_SCIENCE_PACK = ITEMS.register("science_pack_production",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> UTILITY_SCIENCE_PACK = ITEMS.register("science_pack_utility",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> SPACE_SCIENCE_PACK = ITEMS.register("science_pack_space",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> BASIC_CIRCUIT = ITEMS.register("basic_control_circuit",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> ADVANCED_CIRCUIT = ITEMS.register("advanced_control_circuit",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> ELITE_CIRCUIT = ITEMS.register("elite_control_circuit",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> ULTIMATE_CIRCUIT = ITEMS.register("ultimate_control_circuit",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> EXPLOSIVES = ITEMS.register("explosives",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> NUCLEAR_FUEL = ITEMS.register("nuclear_fuel",
            () -> new FuelItem(new Item.Properties(), 240000));

    public static final DeferredItem<Item> LOW_DENSITY_STRUCTURE = ITEMS.register("low_density_structure",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> ROCKET_CONTROL_UNIT = ITEMS.register("rocket_control_unit",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> ROCKET_PART = ITEMS.register("rocket_part",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> URANIUM_235 = ITEMS.register("uranium_235",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> URANIUM_238 = ITEMS.register("uranium_238",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> RAW_DESH = ITEMS.register("raw_desh",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> RAW_OSTRUM = ITEMS.register("raw_ostrum",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> RAW_CALORITE = ITEMS.register("raw_calorite",
            () -> new Item(new Item.Properties()));
