...
public class ModItems {
    ...
    public static final RegistryObject<Item> BASIC_CIRCUIT = ITEMS.register("basic_control_circuit", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> ADVANCED_CIRCUIT = ITEMS.register("advanced_control_circuit", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> ELITE_CIRCUIT = ITEMS.register("elite_control_circuit", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> ULTIMATE_CIRCUIT = ITEMS.register("ultimate_control_circuit", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<Item> LUBRICANT_BUCKET = ITEMS.register("lubricant_bucket",
            () -> new BucketItem(ModFluids.LUBRICANT_FLUID,
