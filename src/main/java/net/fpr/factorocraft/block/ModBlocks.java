...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> COPPER_ORE_VEIN = registerBlock("copper_ore_vein",
            () -> new CopperOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> IRON_ORE_VEIN = registerBlock("iron_ore_vein",
            () -> new IronOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> COAL_ORE_VEIN = registerBlock("coal_ore_vein",
            () -> new CoalOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> TIN_ORE_VEIN = registerBlock("tin_ore_vein",
            () -> new TinOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> URANIUM_ORE_VEIN = registerBlock("uranium_ore_vein",
            () -> new UraniumOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> STONE_VEIN = registerBlock("stone_vein",
            () -> new StoneVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));

    public static final RegistryObject<Block> REDSTONE_ORE_VEIN = registerBlock("redstone_ore_vein",
            () -> new RedstoneOreVein(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)));
